...
public class WebUI {
    ...
    private static final String DEMO_QA_URL_MYINFO = "https://opensource-demo.orangehrmlive.com/index.php/pim/viewMyDetails";
    ...
    protected void setUpWebdriverUrlMyInfo(){
        driver = new ChromeDriver();
        driver.get(DEMO_QA_URL_MYINFO);
    }
    ...
    protected void generalSetUpMyInfo(){
        setUpLog4j2();
        setUpWebdriver();
        setUpWebdriverUrlMyInfo();
    }
